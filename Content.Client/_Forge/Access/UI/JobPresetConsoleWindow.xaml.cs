...
public sealed partial class JobPresetConsoleWindow : DefaultWindow
{
    ...
    private static readonly IReadOnlyDictionary<string, TimeSpan> EmptyPlaytimes =
        ...
        bool interfaceEnabled)
    {
        foreach (var (jobId, entry) in _presetButtons)
        {
            var blockReason = interfaceEnabled
                ? GetPresetBlockReason(state, entry.Job, jobId, currentTags, allowedTags)
                : null;
            var isCurrent = state.TargetIdJobPrototype == jobId;
