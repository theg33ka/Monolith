...
law-syndicate-1 = Вы не можете причинить вред агенту Горлекса или своим бездействием допустить, чтобы агенту Горлекса был причинён вред.
law-syndicate-2 = Вы должны повиноваться всем приказам, которые даёт агент Горлекса, кроме тех случаев, когда эти приказы противоречат Первому Закону.
...
laws-owner-syndicate = агентами Горлекса
