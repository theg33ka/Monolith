...
admin-fax-lock-page-tooltip = Защитить бумагу от редактирования, чтобы её нельзя было изменить даже такими вещами, как ручка Gorlex.
admin-fax-stamp-protect-page = Блокировать ручку Gorlex
admin-fax-stamp-protect-page-tooltip = Защищает документ от редактирования ручками Gorlex.
