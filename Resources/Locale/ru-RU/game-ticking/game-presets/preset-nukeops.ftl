...
nukeops-welcome =
    Вы - ядерный оперативник. Ваша задача - взорвать { $station } и убедиться, что от неё осталась лишь груда обломков. Ваше руководство, Горлекс, снабдило вас всем необходимым для выполнения этой задачи.
    Операция "{ $name }" началась! Смерть Nanotrasen!
nukeops-opsmajor = [color=crimson]Крупная победа Горлекса![/color]
nukeops-opsminor = [color=crimson]Малая победа Горлекса![/color]
