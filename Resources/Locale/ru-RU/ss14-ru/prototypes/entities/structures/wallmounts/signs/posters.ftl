...
ent-PosterContrabandSyndicateRecruitment = Вступайте в Горлекс
...
ent-PosterContrabandSyndicatePistol = Пистолеты Горлекса
    .desc = Плакат, рекламирующий пистолеты Горлекса как "чертовски классные". Он покрыт выцветшими тэгами банд.
...
ent-PosterContrabandFreeSyndicateEncryptionKey = Халявный ключ шифрования Горлекса
...
ent-PosterContrabandRevolt = Революция
    .desc = Революционная пропаганда, выпущенная Горлекс.
ent-PosterContrabandMoth = ГорлексНиан - Ядерные операции
    .desc = Плакат, созданный по заказу Горлекса, с использованием ГорлексНиан™, призывающий зрителя держать диск ядерной аутентификации незащищенным. "Мир никогда не был вариантом!" Ни один хороший сотрудник не станет прислушиваться к этой чепухе.
...
ent-PosterLegit12_gauge = 12-й калибр
