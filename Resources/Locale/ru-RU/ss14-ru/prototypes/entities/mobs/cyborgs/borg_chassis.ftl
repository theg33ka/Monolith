...
ent-BorgChassisService = киборг-официант
    .desc = { ent-BaseBorgChassisNT.desc }
ent-BorgChassisSyndicateAssault = штурмовой киборг Горлекса
    .desc = Машина для убийств с доступом к различным смертоносным модулям.
ent-BorgChassisSyndicateMedical = медицинский киборг Горлекса
...
ent-BorgChassisSyndicateSaboteur = саботажный киборг Горлекса
