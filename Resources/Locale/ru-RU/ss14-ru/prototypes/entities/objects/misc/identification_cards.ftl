...
ent-CentcomIDCard = ID карта старшего офицера
    .desc = { ent-IDCardStandard.desc }
ent-ERTLeaderIDCard = ID карта лидера 
    .desc = { ent-CentcomIDCard.desc }
ent-ERTChaplainIDCard = ID карта священника 
    .desc = { ent-ERTLeaderIDCard.desc }
ent-ERTEngineerIDCard = ID карта инженера 
    .desc = { ent-ERTChaplainIDCard.desc }
ent-ERTJanitorIDCard = ID карта уборщика 
    .desc = { ent-ERTChaplainIDCard.desc }
ent-ERTMedicIDCard = ID карта врача 
    .desc = { ent-ERTChaplainIDCard.desc }
ent-ERTSecurityIDCard = ID карта офицера 
    .desc = { ent-ERTChaplainIDCard.desc }
...
ent-AtmosIDCard = ID карта атмосферного техника
    .desc = { ent-IDCardStandard.desc }
ent-SyndicateIDCard = ID карта Горлекса
    .desc = { ent-IDCardStandard.desc }
