...
ent-UplinkImplant = имплант «аплинк»
    .desc = Этот имплант позволяет владельцу пользоваться спрятанным аплинком Горлекса.
...
ent-DeathRattleImplant = имплант «предсмертный хрип»
    .desc = Этот имплант сообщит в радиоканал Горлекса, если пользователь окажется в критическом состоянии или умрёт.
