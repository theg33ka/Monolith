...
ent-ReinforcementRadioSyndicateAncestor = телепорт подкрепления генетического предка Горлекса
...
ent-ReinforcementRadioSyndicateSyndiCat = телепорт подкрепления Горлекскота
...
ent-ReinforcementRadioSyndicateCyborgAssault = { ent-ReinforcementRadioSyndicate }
    .suffix = радио подкрепления штурмового киборга Горлекса
