...
ent-ClothingHeadHelmetRaid = рейдерский шлем Горлекса
    .desc = Бронированный шлем для использования с рейдерским костюмом Горлекса. Очень стильный.
