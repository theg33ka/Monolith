...
ent-ClothingOuterCoatInspector = пальто инспектора
    .desc = Строгий костюм инспектора для устрашения во время проверок.
...
ent-ClothingOuterCoatSyndieCap = тренч Горлекса
    .desc = Плащ Горлекса, изготовлен из прочной ткани, украшен позолоченными узорами.
ent-ClothingOuterCoatSyndieCapArmored = бронированный тренч Горлекса
    .desc = Бронированный плащ Горлекса, изготовлен из прочной ткани, украшен позолоченными узорами.
