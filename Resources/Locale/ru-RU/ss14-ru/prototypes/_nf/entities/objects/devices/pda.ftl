...
ent-ERTMailCarrierPDA = КПК почтальона
    .suffix = Почтальон
    .desc = { ent-ERTLeaderPDA.desc }
ent-SheriffPDA = КПК командующего офицера
...
ent-NFCaptainShantymanPDA = КПК «Пиратская дискотека»
  .desc = Включает режим «Йо-хо-хо» и превращает любой абордаж в весёлую вечеринку.

ent-NFDetectiveIDCard = КПК детектива
    .desc = Пахнет дождём... льющимся с крыш...
ent-NFJanitorPDA = КПК директора по уходу
    .desc = Пахнет дезинфицирующим средством.
ent-PublicAffairsIDCard = КПК по связям с общественностью
    .desc = Бумаги, бумаги, бумаги!
ent-NFJanitorIDCard = КПК директора по уходу
    .desc = Пахнет дезинфицирующим средством.
ent-DocIDCard = КПК директора по уходу
    .desc = Пахнет дезинфицирующим средством.
ent-DocPDA = КПК директора по уходу
    .desc = Пахнет дезинфицирующим средством.
ent-NFDetectivePDA = КПК детектива
    .desc = Пахнет дождём... льющимся с крыш...
ent-PublicAffairsLiaisonPDA = КПК по связям с общественностью
    .desc = Бумаги, бумаги, бумаги!
