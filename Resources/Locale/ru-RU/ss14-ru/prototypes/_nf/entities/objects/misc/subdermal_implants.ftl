...
ent-RadioImplantFreelance = имплант фриланс-радио
    .desc = Этот имплант даёт доступ к каналу «Фриланс» без гарнитуры.
ent-RedLightImplant = имплант подсветки (красный)
    .desc = Этот имплант излучает свет с кожи пользователя при активации.
ent-DissonantWhispersImplant = имплант диссонирующих шёпотов
