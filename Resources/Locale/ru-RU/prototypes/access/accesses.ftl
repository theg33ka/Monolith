...
id-card-access-level-syndicate-agent = Агент Горлекса
id-card-access-level-central-command = Управление Секторальным Флотом
id-card-access-level-emergency-shuttle-repeal = Эв. шаттл Отменить автор.
id-card-access-level-genpop-enter = Генпоп вход
id-card-access-level-genpop-leave = Генпоп выход
