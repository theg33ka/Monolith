roles-antag-syndicate-agent-name = Агент Горлекса
roles-antag-syndicate-agent-objective = Выполните свои задачи и не попадитесь.
roles-antag-syndicate-agent-sleeper-name = Спящий агент Горлекса
roles-antag-syndicate-agent-sleeper-objective = Разновидность агента Горлекса, который может активироваться и начать действие в любой момент смены.
...
roles-antag-generic-silicon-antagonist-name = дефектный
roles-antag-paradox-clone-name = Парадокс клон
roles-antag-paradox-clone-objective = Пространственно-временная аномалия телепортировала вас в другую реальность! Теперь вы должны найти своего аналога, убить и заменить его.
