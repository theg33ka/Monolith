...
tips-dataset-31 = Будучи предателем, вы можете использовать гарнитуру Горлекса для поддержания связи с любым другим, купившим гарнитуру, предателем.
tips-dataset-32 = Будучи предателем, прослушивание важных каналов связи, таких как служба безопасности или инженернов, может дать ценные сведения. Имейте в виду, что это происходит в обоих направлениях — служба безопасности также может прослушивать канал связи Горлекса!
...
tips-dataset-106 = Противогаз Горлекса блокирует свет от вспышек, это означает, что Ядерные Оперативники и другие сомнительные личности, которые носят его, не могут быть ослеплены.
