...
war-declarator-conditions-left-outpost = Шаттл покинул аванпост Горлекса
...
war-declarator-default-message = Пограничный отряд Горлекса объявляет о своём намерении уничтожить станцию при помощи ядерного устройства и призывает экипаж предпринять ничтожную попытку остановить их.
